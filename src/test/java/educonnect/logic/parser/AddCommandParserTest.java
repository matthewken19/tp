...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB + STUDENT_ID_DESC_BOB + EMAIL_DESC_BOB
                + TELEGRAM_HANDLE_DESC_BOB + LINK_DESC_BOB + TAG_DESC_FRIEND + TIMETABLE_DESC_VALID1,
        ...
        assertParseSuccess(parser,
                ...
                + TELEGRAM_HANDLE_DESC_BOB + LINK_DESC_BOB + TAG_DESC_HUSBAND
        ...
        Student expectedStudentWithNoTimetable = new StudentBuilder(AMY)
                .withTimetable(DEFAULT_EMPTY_TIMETABLE).build();
        assertParseSuccess(parser,
                NAME_DESC_AMY + STUDENT_ID_DESC_AMY + EMAIL_DESC_AMY
                + TELEGRAM_HANDLE_DESC_AMY + LINK_DESC_AMY + TAG_DESC_FRIEND,
                new AddCommand(expectedStudentWithNoTimetable));

        // no link in command
        Student expectedStudentWithNoLink = new StudentBuilder(AMY)
    ...
    public void parse_repeatedNonTagValue_failure() {
        ...
        // multiple links
        assertParseFailure(parser, LINK_DESC_AMY + validExpectedStudentString,
        ...
        assertParseFailure(parser,
                ...
                Messages.getErrorMessageForDuplicatePrefixes(PREFIX_NAME,
                        PREFIX_TELEGRAM_HANDLE, PREFIX_EMAIL, PREFIX_STUDENT_ID, PREFIX_TIMETABLE, PREFIX_LINK));
        ...
        // invalid link
        assertParseFailure(parser, validExpectedStudentString + INVALID_LINK_DESC,
                Messages.getErrorMessageForDuplicatePrefixes(PREFIX_LINK));
